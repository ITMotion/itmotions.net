...
<body>
	<div class="container">
		...
		<div class="col-md-6" id="contenido1">
			<div class="jumbotron">
				<h2>Bienvenido</h2>
				<p>Somos ITMotions, una empresa jóven con una nueva iniciativa. Dedicados a desarrollo de proyectos informáticos. </p>
				<a class="btn" href="quienessomos.php">Conócenos »</a>
			</div>
		</div>
	</div>
		<br>
